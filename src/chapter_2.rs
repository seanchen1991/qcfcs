...
fn test_complex_matrix_dagger_op() {
    let x = arr2(&[
        [Complex32::new(6.,-3.), Complex32::new(2.,12.), Complex32::new(0.,-19.)],
        [Complex32::new(0.,0.), Complex32::new(5.,2.1), Complex32::new(17.,0.)],
        [Complex32::new(1.,0.), Complex32::new(2.,5.), Complex32::new(3.,-4.5)],
    ]);
    let expected = arr2(&[
